...
data1 = np.linspace(1, 10, num=1000)
data2 = np.linspace(1, 10, num=1000) + np.random.random(size=1000)
data3 = np.linspace(10, 1, num=1000)
target = data1 * 2 + data3 * 0.1 + data2 * 1 + 10 * data1 * data2 + np.random.random(size=1000)
